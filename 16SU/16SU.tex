...
\MiniTask{Set up on Midway - look at ``onboarding'' sheet of paper Valeri scribbled notes on}
...
\MiniTask{Used \href{http://www.astropy.org/astropy-tutorials/FITS-images.html}{astropy} site}

\MiniTask{Render Median then log normal it}
\MiniTask{Log the numpy array then render median - Compare}
...
%%% ------------------------------------------------------------
\IP
\Task{Get set up on Midway}
\MiniTask{Get my password....}
\MiniTask{Pull the code from repo onto midway}
\MiniTask{Download fits images from photon into midway}
\MiniTask{Test bits of code in midway to make sure everything necessary is downloaded}
