...
\IP
\MiniTask{Check rotation scale invariant descriptors: SIFT, SURF, ORB - or, orb, daisy, hessian_matrix_det.... etc.}
...
\Task{Reimbursements}
\MiniTask{Minnesota}
\MiniTask{Fellows at the Frontiers - CIERA expense report, ask about travel on L (\$5?)}

\Task{NSF reporting for KICP: PIN 3529}
\MiniTask{\href{https://www.fastlane.nsf.gov/cgi-bin/people}{NSF form}}

\Task{AGN - Look at particle reader and CART code, identify how AGN particles are stored.}
\Task{AGN - Figure out how to pull AGN data.}

\IP
\MiniTask{No clipping or normalization, norm=True in HOG, run grid search to get HOG parameters, get score vs. C plot}
