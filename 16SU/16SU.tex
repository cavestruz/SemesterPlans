...
\newcommand{\DoneTask}[1]{
  \hspace{3pt}  {\small\st{#1}} \par\par% Task Description
}
...
\MiniTask{Get fit\_samples ported over, looking at test\_load\_samples.fit\_samples, port into training\_steps.py}
