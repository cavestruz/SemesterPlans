...
\MiniTask{Try with different parameters for HOG, given best params for median - Note: HOG outputs a 1-d histogram, need to find a good way to visualize the info we get out of this}
